countDownDate = new Date("March 1, 2022 24:00:00").getTime();
...
function animate(index) {
  document
    .querySelectorAll(".countdown-bottomcard")
    [index].classList.add("flipcard");
  document
    .querySelectorAll(".countdown-bottomcard")
    [index].classList.remove("flipback");
...
function stop(index) {
  ...
  document
    .querySelectorAll(".countdown-bottomcard")
    [index].classList.remove("flipcard");
  document
    .querySelectorAll(".countdown-bottomcard")
    [index].classList.add("flipback");
}
